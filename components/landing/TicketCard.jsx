export const TicketCard = () => {
  return (
    <div className="hidden md:flex flex-col border-2 gap-2 w-70 p-3 absolute md:-bottom-5 lg:-bottom-20 md:right-5 lg:right-0 z-10 bg-magenta -translate-y-1.25 hover:translate-1.75 hover:shadow-none shadow-[7px_7px_0px_0px_#323232] transition-all">
