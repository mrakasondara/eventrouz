...
function AlertDialogAction({
  ...
  return (
    <Button
      ...
      className={cn(
        className,
        "-translate-y-[1px] hover:translate-[3px] shadow-[3px_3px_0px_0px_#323232] hover:shadow-none text-white border-black"
      )}
      {...props}
    />
  );
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Close
      ...
      className={cn(
        className,
        "-translate-y-[1px] hover:translate-[3px] shadow-[3px_3px_0px_0px_#323232] hover:shadow-none cursor-pointer"
      )}
